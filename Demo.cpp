...
// int main() {
//     //std::vector<double> baseA = {3, 4, -1, 2, 5, 2.4, 3, 3, 7, 4, 4, 11.3};
//     /*
//     * [ 3, 4, -1, 2 ]
//     * [ 5, 2.4, 3, 3 ]
//     * [ 7, 4, 4, 11.3]
...
//     std::vector<double> multtestA = {2, 1, 1, 9};
//     std::vector<double> multtestB = {3, 9, 4, 7};
//     Matrix A{multtestA, 2, 2};
//     Matrix B{multtestA, 2, 2};
//     std::cout << B << "\n" << B*3 << "\n" << 3*B;
